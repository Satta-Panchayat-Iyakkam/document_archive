...
(function($, SPI) {
	...
	function change_layout(cls) {
		...
		if (cls == "layout-boxed")
			SPI.controlSidebar._fix($(".control-sidebar-bg"));
		if ($('body').hasClass('fixed') && cls == 'fixed') {
			SPI.pushMenu.expandOnHover();
			SPI.layout.activate();
		}
		SPI.controlSidebar._fix($(".control-sidebar-bg"));
		SPI.controlSidebar._fix($(".control-sidebar"));
	}
	...
	function setup() {
		...
		$("[data-controlsidebar]").on('click', function() {
			...
			var slide = !SPI.options.controlSidebarOptions.slide;
			SPI.options.controlSidebarOptions.slide = slide;
			if (!slide)
